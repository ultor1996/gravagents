...
for det in strain_data:
    ...
    try:
        ...
        # CRITICAL: Use delta_f, not sample_rate
        delta_f = 1.0 / seg_len_sec
        # Convert data to PyCBC TimeSeries for compatibility
        pycbc_data = PyCBC_TimeSeries(data, delta_t=1.0/sample_rate)
        psd = welch(
            pycbc_data,
